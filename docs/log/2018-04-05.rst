...
--------
    ...
    2. Simulated maps
        ...
        - Emission laws 
            - synchrotron
.. math::
    \bm{m}^{\nu}_{\text{sync}} = \bm{m}_{\text{sync}} \left(\frac{\nu}{\nu_{\text{S}}} \right) ^{\beta_{\text{S}}(\bm{\hat{n}}) \\
    \bm{m}^{\nu}_{\text{dust}} = \bm{m}_{\text{dust}} \left(\frac{\nu}{\nu_{\text{D}}} \right) ^{\beta_{\text{D}}(\bm{\hat{n}}-2) \frac{B _\nu [T_D(\bm{\hat{n}})]}{B_{\nu_D} [T_D(\bm{\hat{n}})]}.
.
        - 
